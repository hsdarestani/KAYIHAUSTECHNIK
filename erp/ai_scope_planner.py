...
COVER_WORDS = ("abdecken", "abgedeckt", "abdeckung", "abdeckarbeiten", "abkleben", "abgeklebt", "schutzen", "schützen", "geschutzt", "geschützt", "geschuetzt")
...
def _read_explicit_facts(state: dict[str, Any], message: str) -> None:
    ...
    damage_words = ("schaden", "schäden", "vorschaden", "vorschäden", "bestandschaden", "bestandschäden", "mangel", "mängel")
