...
CSS_LINK = '<link rel="stylesheet" href="/static/css/ab-bau-v3-appointment-detail.css?v=20260908-2">'
...
def patch_detail_template() -> None:
    ...
    if "data-ab-v3-appointment-detail" not in text:
        # Field Authorization owns the final Termin template in production. Older
        # assemblies still used nx-field-shell, so accept both without weakening
        # the guard. This runs after all ToolTime/V3 layers and must be idempotent.
        candidates = (
            (
                '<div class="fa-mobile-shell" data-field-authorization-root>',
                '<div class="fa-mobile-shell ab-v3-appointment-detail" data-field-authorization-root data-ab-v3-appointment-detail>',
            ),
            (
                '<div class="nx-field-shell">',
                '<div class="nx-field-shell ab-v3-appointment-detail" data-ab-v3-appointment-detail>',
            ),
        )
...
def patch_base_stylesheet() -> None:
    text = read(BASE_REL)
    # Replace an older version if a partial run already installed the link.
    import re
    text = re.sub(
...
body.ab-v3 .ab-v3-appointment-detail{
  width:100%!important;max-width:1240px!important;margin:0 auto 42px!important;
...
body.ab-v3 .ab-v3-appointment-detail>.nx-pagehead{
  ...
  align-items:end!important;gap:22px!important;margin:0!important;padding:2px 2px 18px!important;
  border-bottom:1px solid var(--v3-line,#ded7cb)!important;
}
body.ab-v3 .ab-v3-appointment-detail>.nx-pagehead h1{
  margin:5px 0 4px!important;font-size:clamp(29px,3vw,42px)!important;
  line-height:1.02!important;letter-spacing:-.045em!important;
}
body.ab-v3 .ab-v3-appointment-detail>.nx-pagehead p{margin:0!important;color:#77736b!important}
body.ab-v3 .ab-v3-appointment-detail>.nx-pagehead .nx-actions{
  display:flex!important;align-items:center!important;justify-content:flex-end!important;
  flex-wrap:wrap!important;gap:8px!important;
}

/* Phase-14 markup survives the V3 assembly; make its visual contract final too. */
body.ab-v3 .ab-v3-appointment-detail .tt-appt-detail-summary,
body.ab-v3 .ab-v3-appointment-detail .tt-appt-process-services{
  display:grid!important;gap:14px!important;margin:0!important;padding:19px 20px!important;
  border:1px solid var(--v3-line,#ded7cb)!important;border-radius:18px!important;
  background:rgba(255,253,248,.98)!important;box-shadow:0 10px 28px rgba(14,16,19,.045)!important;
}
...
body.ab-v3 .ab-v3-appointment-detail .tt-appt-detail-summary-head{
  padding-bottom:14px!important;border-bottom:1px solid #e8e1d5!important;
}
body.ab-v3 .ab-v3-appointment-detail .tt-appt-detail-summary-head>div,
...
body.ab-v3 .ab-v3-appointment-detail .tt-appt-process-head span{
  color:#8b857c!important;font-size:9px!important;font-weight:820!important;
...
body.ab-v3 .ab-v3-appointment-detail .tt-appt-process-head strong{
  color:#181a1d!important;font-size:16px!important;letter-spacing:-.02em!important;
}
body.ab-v3 .ab-v3-appointment-detail .tt-appt-detail-facts{
  display:grid!important;grid-template-columns:1.05fr .75fr 1fr 1.35fr!important;gap:10px!important;
}
body.ab-v3 .ab-v3-appointment-detail .tt-appt-detail-facts>div{
  display:grid!important;align-content:start!important;gap:5px!important;min-width:0!important;
  padding:13px 14px!important;border:1px solid #e7e0d5!important;border-radius:13px!important;background:#faf7f1!important;
}
body.ab-v3 .ab-v3-appointment-detail .tt-appt-detail-facts strong{
  overflow-wrap:anywhere!important;color:#2d3034!important;font-size:12px!important;line-height:1.45!important;
}
body.ab-v3 .ab-v3-appointment-detail .tt-appt-detail-location{
  display:flex!important;align-items:center!important;gap:12px!important;padding:13px 15px!important;
  border:1px solid #e4ddd0!important;border-radius:13px!important;background:#f3efe6!important;
}
body.ab-v3 .ab-v3-appointment-detail .tt-appt-detail-location>span{
  ...
  border:1px solid #ddd3c2!important;border-radius:11px!important;background:#fffdf8!important;color:#9b7728!important;font-size:18px!important;
}
...
body.ab-v3 .ab-v3-appointment-detail .tt-appt-process-table{
  display:grid!important;overflow:hidden!important;border:1px solid #e5ded2!important;border-radius:11px!important;
}
body.ab-v3 .ab-v3-appointment-detail .tt-appt-process-table>div{
  display:grid!important;grid-template-columns:120px 80px 80px minmax(0,1fr)!important;gap:8px!important;
  padding:9px 11px!important;border-top:1px solid #ebe5da!important;font-size:11px!important;
}
body.ab-v3 .ab-v3-appointment-detail .tt-appt-process-table>.head{
  border-top:0!important;background:#f4f0e8!important;color:#817b72!important;font-size:8.5px!important;
  font-weight:820!important;letter-spacing:.08em!important;text-transform:uppercase!important;
}
body.ab-v3 .ab-v3-appointment-detail .tt-appt-process-actions{
  display:flex!important;justify-content:flex-end!important;flex-wrap:wrap!important;gap:8px!important;
}
...
body.ab-v3 .ab-v3-appointment-detail .tt-appt-process-empty{
  padding:12px!important;border:1px dashed #d7cfc2!important;border-radius:10px!important;background:#faf7f1!important;color:#7c766e!important;font-size:11px!important;
}

/* Preserve the proven field workflow, but make the full desktop page feel like one system. */
body.ab-v3 .ab-v3-appointment-detail .fa-site-card,
body.ab-v3 .ab-v3-appointment-detail .fa-card{margin-top:0!important;min-width:0!important}
body.ab-v3 .ab-v3-appointment-detail .fa-card{padding:18px!important}
body.ab-v3 .ab-v3-appointment-detail .fa-progress{margin:0!important}
...
@media(max-width:760px){
  body.ab-v3 .ab-v3-appointment-detail{margin:-6px -5px 30px!important;gap:10px!important}
  body.ab-v3 .ab-v3-appointment-detail>.nx-pagehead{grid-template-columns:1fr!important;align-items:start!important;gap:13px!important;padding:0 8px 14px!important}
  body.ab-v3 .ab-v3-appointment-detail>.nx-pagehead .nx-actions{justify-content:flex-start!important;width:100%!important}
  body.ab-v3 .ab-v3-appointment-detail .tt-appt-detail-summary,
  body.ab-v3 .ab-v3-appointment-detail .tt-appt-process-services{margin-left:7px!important;margin-right:7px!important;padding:15px!important;border-radius:15px!important}
  body.ab-v3 .ab-v3-appointment-detail .tt-appt-detail-summary-head,
  ...
  body.ab-v3 .ab-v3-appointment-detail .fa-card{padding:13px!important}
}
...
def guard() -> None:
    ...
    base = read(BASE_REL)
    css = read(CSS_REL)
    for marker in ("data-ab-v3-appointment-detail", "ab-v3-appointment-detail", "tt-appt-detail-summary", "tt-appt-process-services"):
    ...
    for marker in ("A+BAU V3 APPOINTMENT DETAIL LAYOUT FIX", ".tt-appt-detail-summary", ".tt-appt-process-services", "grid-template-columns:repeat(2,minmax(0,1fr))", "@media(max-width:760px)"):
