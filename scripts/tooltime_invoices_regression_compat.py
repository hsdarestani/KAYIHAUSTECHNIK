...
def patch_invoice_actions() -> None:
    ...
    # Reuse the existing Phase-4 lifecycle JavaScript for the real partial-payment
    # modal. The exact list keeps its own independent search/filter/menu runtime.
    ...
    # The screenshot-exact row menu must retain all authoritative lifecycle/Pay
    # operations: manual partial payment, reminder, provider checkout and dunning
    # automation. Every mutation goes to an existing server-side endpoint.
    ...
    modal_marker = 'data-payment-modal'
