...
# Android/Chrome can deny getUserMedia even when Web Speech appeared available.
...
# photo calibration separates 2D scale from 3D dimensions, and dispatch gets a
