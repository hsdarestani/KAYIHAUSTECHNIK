...
# Customer and project pages are the next ToolTime baseline surface. Run this after
# every generated/legacy layer so Kundenverlauf/Projektverlauf and their actions win.
python3 scripts/tooltime_customer_project_history.py

echo "A+Bau source tree assembled with ToolTime-parity commercial documents, customer/project histories, German fiscal compliance, AI/3D advantages and stable operational UX."
